...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("10.47.37.246"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124)}, "/Users/arunavgupta/Downloads/circle-menu/CircleMenu.unoproj", GetBundle, new string[] { })
{
...
{
return Uno.IO.Bundle.Get("CircleMenu");
}
}
}
